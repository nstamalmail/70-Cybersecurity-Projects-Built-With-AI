...
APP: dict = {
    "slug": "tatp",
    "acronym": "TATP",
    "exe": "TATP-TTPProfiler",
    "name": "TTP Profiler",
    "title": "Threat Actor TTP Profiler",
    "subtitle": "TTP aggregation \\u00b7 IOC extraction \\u00b7 ATT\\u0026CK mapping \\u00b7 remediation",
    "version": "1.0.0",
    "vendor": "Malware Analysis Workbench",
    "report_title": "Threat Actor TTP Profile Report",
    ...
    "description": (
        "Aggregates TTPs from analyzed samples from sandbox behaviour reports. "
