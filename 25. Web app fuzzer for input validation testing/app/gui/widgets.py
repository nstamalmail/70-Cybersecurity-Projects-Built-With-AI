"""Dark theme + reusable widgets for the WebFuzzer GUI."""
...
BG_ALT = "#27293d"    # card / panel background
BG_INPUT = "#16161e"  # entry / text background
FG = "#cdd6f4"        # primary text
FG_DIM = "#7f849c"    # muted text
ACCENT = "#89b4fa"    # buttons / selection
ACCENT_HOVER = "#74c7ec"
DANGER = "#f38ba8"
WARN = "#f9e2af"
OK = "#a6e3a1"
...
def make_tree(parent, columns: list, headings: list, widths: list,
              selectmode: str = "browse") -> ttk.Treeview:
    """Standard configured Treeview with scrollbars."""
