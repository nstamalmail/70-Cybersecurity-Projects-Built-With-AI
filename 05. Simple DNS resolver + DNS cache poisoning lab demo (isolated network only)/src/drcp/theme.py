"""Shared dark theme constants for DRCP (DNS Lab)."""
BACKGROUND = "#12151c"
PANEL = "#1a1f2b"
PANEL_ALT = "#202636"
BORDER = "#2c3446"
...
QPushButton#danger { background-color: #e74c3c; border: none; font-weight: bold; }
QLineEdit, QSpinBox, QComboBox, QPlainTextEdit { background-color: #1a1f2b;
...
QProgressBar { background-color: #1a1f2b; border: 1px solid #2c3446; border-radius: 4px;
...
QTextBrowser, QListWidget, QTreeWidget { background-color: #1a1f2b;
    border: 1px solid #2c3446; border-radius: 4px; }
